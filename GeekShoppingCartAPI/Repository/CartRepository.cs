...
namespace GeekShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public CartRepository(MySQLContext sqlContext, IMapper mapper)
        {
            _context = sqlContext;
            _mapper = mapper;
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO vo)
        {
            ...
            // Verifica se o produto já existe na database, se nao existe, salva ele
            ...
            {
                //Check of CartDetails has same product
